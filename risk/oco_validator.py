...
try:
    ...
    print("⚠️  Phase 22 alerting system not available - using local logging")
...
if __name__ == "__main__":
    # Self-test mode - create sample broker for testing
    print("🔧 RBOTzilla UNI - OCO Link Validator Self-Test")
    print("PIN: 841921 | Phase 24 | OCO Enforcement System")
    print()
    
    class SampleBroker:
        def __init__(self):
            self.name = "sample_broker"
        ...
        def close_position(self, position_id):
            print(f"Sample: Closing position {position_id}")
            return True
    ...
    print("Running OCO validation self-test...")
    results = validator.validate_open_positions(sample_broker)
    ...
    print("\n🎉 OCO Validator Self-Test Complete!")