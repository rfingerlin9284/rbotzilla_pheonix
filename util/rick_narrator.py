...
class RickNarrator:
    ...
    def check_ollama(self) -> bool:
        ...
        try:
            ...
            logger.warning("⚠️ Ollama not available - using template narration")
            return False
...
Give a brief one-sentence comment. Be casual and informative. Under 30 words."""
        ...
        return self.template_narration(event_type, details)
    ...
    def template_narration(self, event_type: str, details: Dict[str, Any]) -> str:
        """Template-based narration when Ollama is unavailable"""
