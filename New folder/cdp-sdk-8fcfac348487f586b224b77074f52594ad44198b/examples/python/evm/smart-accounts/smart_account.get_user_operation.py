# Usage: uv run python evm/smart-accounts/smart_account.get_user_operation.py
...
async def main():
    async with CdpClient() as cdp:
        ...
        await smart_account.wait_for_user_operation(
        ...
        print("User Operation Result:", user_op)
