// Usage: pnpm tsx evm/swaps/account.swapWithNetworkHoisting.ts
...
console.log(`Note: This example is using ${NETWORK} network. Make sure you have funds available.`);
  ...
  console.log(`Base account created: ${baseAccount.address}`);
  ...
  console.log('Please uncomment the code below to execute the swap.');
   ...
   try {
     ...
     if (NETWORK === 'optimism') {
       console.log(`Transaction Explorer: https://explorer.optimism.io/tx/${result.transactionHash}`);
     } else if (NETWORK === 'arbitrum') {
       console.log(`Transaction Explorer: https://arbiscan.io/tx/${result.transactionHash}`);
     }
   } catch (error) {
