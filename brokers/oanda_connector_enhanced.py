...
class EnhancedOandaConnector:
    ...
    def __init__(self, pin: int = None, environment: str = None):
        ...
        # Load API credentials from parameter manager, then .env if needed
    ...
    def _load_credentials(self):
        """
        Load API credentials from parameter manager, then .env file if needed
        ...
        # If credentials are missing in parameter manager, read them from .env
    ...
    def _validate_connection(self):
        ...
        if self.environment == "live" and (not self.api_token or not self.account_id):
            ...
            self.logger.warning("Practice OANDA credentials not configured - trading will be disabled")
        else:
